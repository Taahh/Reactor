...
namespace Reactor
{
    public class Coroutines2
    {
        ...
        public static readonly List<IEnumerator> _ourWaitForFixedUpdateCoroutines = new List<IEnumerator>();
        ...
        public static void ProcessCoroutineList(List<IEnumerator> target)
        {
    ...
    public static class CouroutineFixedUpdatePatch
    {
        public static void Postfix()
        {
            Coroutines2.ProcessCoroutineList(Coroutines2._ourWaitForFixedUpdateCoroutines);
        }
    }

    //[HarmonyPatch(typeof(FollowerCamera), nameof(FollowerCamera.Update))]
    public static class CouroutineUpdatePatch
    {
        public static void Postfix()
        {
            Coroutines2.Process();
